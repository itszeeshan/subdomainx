...
**API**: [URLScan.io API](https://urlscan.io/docs/api/)
...
**Website**: [ThreatCrowd](https://www.threatcrowd.org/)  
**Setup**: No setup required (public API)  
**API**: [ThreatCrowd API](https://www.threatcrowd.org/api/)
...
**Website**: [HackerTarget](https://hackertarget.com/)  
**Setup**: Set `HACKERTARGET_API_KEY` environment variable (optional, for higher rate limits)  
**API**: [HackerTarget API](https://hackertarget.com/api/)
