...
```bash
subdomainx --securitytrails --virustotal --censys --linkheader example.com
```

**Multiple domains:**

```bash
subdomainx --wildcard domains.txt --securitytrails --virustotal --censys --linkheader
```
...
```bash
subdomainx --subfinder --amass --securitytrails --virustotal --censys --waybackurls --linkheader --httpx --smap example.com
```

**Multiple domains:**

```bash
subdomainx --wildcard domains.txt --subfinder --amass --securitytrails --virustotal --censys --waybackurls --linkheader --httpx --smap
```
