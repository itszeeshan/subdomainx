...
```bash
subdomainx --wildcard domains.txt --amass --virustotal --censys --httpx
```

> **Note**: Combines the speed of local tools with the breadth of API databases
...
```bash
subdomainx --subfinder --amass --securitytrails --virustotal --censys --httpx --smap example.com
```

**Multiple domains:**

```bash
subdomainx --wildcard domains.txt --subfinder --amass --securitytrails --virustotal --censys --httpx --smap
```
