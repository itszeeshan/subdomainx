...
```bash
subdomainx --wildcard domains.txt --amass --virustotal --censys --waybackurls
```

> **Note**: Combines the speed of local tools with the breadth of API databases and historical data
...
```bash
subdomainx --securitytrails --virustotal --censys --httpx example.com
```

**Multiple domains:**

```bash
subdomainx --wildcard domains.txt --securitytrails --virustotal --censys --httpx
```
...
```bash
subdomainx --subfinder --amass --securitytrails --virustotal --censys --waybackurls --httpx --smap example.com
```

**Multiple domains:**

```bash
subdomainx --wildcard domains.txt --subfinder --amass --securitytrails --virustotal --censys --waybackurls --httpx --smap
```
